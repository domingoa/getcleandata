...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>datasciencecoursera/HelloWorld.md at master · subhaoi/datasciencecoursera</title>
...
<meta content="bqC0xen3tLdmUG3NFHhtSk4M/5afp8JHJJ0PMjjRbXSKVRF97LsSzmHQTQoL2SpIXqyCXkVuOlddeMIRgg0Olw==" name="csrf-token" />
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="j5dVNRoFo6p5T/LfO8m8OgvnglzHcIWInlD1GNYYDdMEK83HdVgM2DWrBcYMtq2bubxAuOXydkouDNb9Tm2k7A==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="19903730" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/subhaoi/datasciencecoursera/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="fgUdPpGuyrG81aQqa62RWq7Dr4bBB045GZv1wDJCK6s6RdMY9G/xDIDgVZSMHReiJCdakVEDYqkUuuBpORNnqQ==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/subhaoi/datasciencecoursera/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="hRkPTlkGx+3rfad1TCosScXQcW6vWy7Ja27E//oWl/mOIfPrkaOS2gQ0pyWBbBdj6E4YEcHbQzGjpSgNSGCuBg==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/subhaoi/datasciencecoursera/blob/fa4871e5e07c2e079957da061feff51253f15752/HelloWorld.md" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:77c9bc48d7a1c13a72781a08ca1d1abf -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/subhaoi/datasciencecoursera/blob/master/HelloWorld.md"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
          ...
          <form accept-charset="UTF-8" action="/subhaoi/datasciencecoursera/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="gth2O+uGRx0BAl/NYHA7xfihWbWBPjGSwtQRaakZuEefsYUJhIcIKFvEA1uFWdUUet8oZbbBoxbeJFriHUs0TA==" /></div>
  ...
  <div class="breadcrumb">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/subhaoi/datasciencecoursera" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">datasciencecoursera</span></a></span></span><span class="separator"> / </span><strong class="final-path">HelloWorld.md</strong> <button aria-label="copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="HelloWorld.md" data-copied-hint="copied!" type="button"><span class="octicon octicon-clippy"></span></button>
  </div>
</div>


  <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/subhaoi/datasciencecoursera/contributors/master/HelloWorld.md">
            ...
            <a class="minibutton tooltipped tooltipped-w"
               href="http://windows.github.com" aria-label="Open this file in GitHub for Windows">
                ...
                <a class="minibutton js-update-url-with-hash"
                   href="/subhaoi/datasciencecoursera/edit/master/HelloWorld.md"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/subhaoi/datasciencecoursera/raw/master/HelloWorld.md" class="button minibutton " id="raw-url">Raw</a>
            <a href="/subhaoi/datasciencecoursera/blame/master/HelloWorld.md" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/subhaoi/datasciencecoursera/commits/master/HelloWorld.md" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon"
               href="/subhaoi/datasciencecoursera/delete/master/HelloWorld.md"
...
<a name="user-content-this-is-a-markdown-file" class="anchor" href="#this-is-a-markdown-file"><span class="octicon octicon-link"></span></a>This is a markdown file</h2></article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04643s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
